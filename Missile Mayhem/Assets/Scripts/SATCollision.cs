...
public class SATCollision : MonoBehaviour
{
        ...
        out Vector3 backRight, out Vector3 backLeft)
    {
        ...
        forwardLeft = (transform.position + transform.up * transform.localScale.y/3.5f ) - transform.right * transform.localScale.x/1.3f ;
        forwardRight = (transform.position + transform.up * transform.localScale.y/3.5f ) + transform.right * transform.localScale.x/1.3f ;
        backLeft = (transform.position - transform.up * transform.localScale.y/3.5f ) - transform.right * transform.localScale.x/1.3f ;
        backRight = (transform.position - transform.up * transform.localScale.y/3.5f ) + transform.right * transform.localScale.x/1.3f ;
    }
